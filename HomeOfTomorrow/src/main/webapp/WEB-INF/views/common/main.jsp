...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/css/maineffect.css">
...
@font-face {
 ...
 .slider_back{
 	...
 	color : #fff;
 	font-weight:800;
 	background-image : linear-gradient(to top, rgba(130, 123, 109,0.5)30%, transparent);
						...
						<div class="item_list_box">
							<div class="thumbnail">
								...
								<div class="button">
									...
									<ul class="other">
										<li class="option"><a onclick="">
											<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												 viewBox="0 0 550 550" style="enable-background:new 0 0 512 512;" xml:space="preserve" fill="#868687">
														<g>
