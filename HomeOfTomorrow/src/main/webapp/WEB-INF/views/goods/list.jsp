					...
					<div class="col-6 col-md-3 product-item-wrap">
						<div class="production-item production-item__placeholder">
							<div class="production-item-image production-item__image">
								<img class="image" src="<%=request.getContextPath()%>/resources/listgoods/7.jpg">
							</div>
							
							<div class="production-item__content">
								<h1 class="production-item__header">
									<span class="production-item__header__brand">베드리움 </span>
									<span class="production-item__header__name">모션LED 사이드 서랍형 침대(SS/Q)</span>
								</h1>
								<span class="production-item-price">
									<span class="production-item-price__rate">43<span class="percentage">% </span></span>
									<span class="production-item-price__price">259,000</span>
								</span> 
								<span class="production-item-badge-list">
									<svg class="icon" aria-label="무료배송" width="47" height="20" viewBox="0 0 47 20" preserveAspectRatio="xMidYMid meet">
										<g fill="none" fill-rule="evenodd"> 
					...
					<div class="col-6 col-md-3 product-item-wrap">
						<div class="production-item production-item--placeholder">
							...
							<div class="production-item__content">
								...
								<div class="placeholder-anim production-item-price production-item-price--placeholder"></div>
								<div class="placeholder-anim production-item-stats production-item-stats--placeholder"></div>
								<div
