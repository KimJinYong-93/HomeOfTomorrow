...
=======
<%@page import="com.spring.HOT.dto.GoodsVO"%>
<%@page import="java.util.List"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
>>>>>>> branch 'master' of https://github.com/KimJinYong-93/HomeOfTomorrow.git
						...
						<div class="col-6 col-md-3 product-item-wrap">
							<div class="production-item production-item__placeholder">
								<div class="production-item-image production-item__image">
									<img class="image" id="goodsImg" src="<%=request.getContextPath()%>/goods/getPicture?picture=${goods.picture}">
								</div>
								
								<div class="production-item__content">
									<h1 class="production-item__header">
										<span class="production-item__header__brand" id="bname">${goods.bname }</span>
										<span class="production-item__header__name">${goods.gname }</span>
									</h1>
									<span class="production-item-price">
										<span class="production-item-price__rate">43<span class="percentage">% </span></span>
										<span class="production-item-price__price"><fmt:formatNumber type="number">${goods.price }</fmt:formatNumber></span>
									</span> 
									<span class="production-item-badge-list">
										<svg class="icon" aria-label="무료배송" width="47" height="20" viewBox="0 0 47 20" preserveAspectRatio="xMidYMid meet">
											<g fill="none" fill-rule="evenodd"> 
...
<script>
	...
	$('.category').on('click', function(){
		//var cg_code = $(this).attr('id');
		var data = {cg_code : $(this).attr('id')};
		$.ajax({
